...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<?php if ( 'twu-portfolio' == get_post_type() ) :
			echo get_the_term_list( $post->ID, 'twu-portfolio-type', '<span class="portfolio-entry-meta">', _x(', ', 'Used between list items, there is a space after the comma.', 'illustratr' ), '</span>' );
...
\		<?php if ( is_search() ) : // Only display Excerpts for Search ?>
	...
	<footer class="entry-meta">
		...
		<?php if ( 'twu-portfolio' == get_post_type() ) :  ?>
			...
			<?php echo get_the_term_list( get_the_ID(), 'twu-portfolio-tag', '<span class="portfolio-entry-meta">', _x(', ', 'Used between list items, there is a space after the comma.', 'illustratr' ), '</span>' ); ?>
		
		<?php else:
				if ( 'post' == get_post_type() ) : // Hide post meta for pages on Search ?>
