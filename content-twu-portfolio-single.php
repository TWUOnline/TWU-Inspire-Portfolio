...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<?php echo get_the_term_list( $post->ID, 'twu-portfolio-type', '<span class="portfolio-entry-meta">', _x(', ', 'Used between list items, there is a space after the comma.', 'illustratr' ), '</span>' ); ?>
	</header><!-- .entry-header -->
	...
	<footer class="entry-meta">
		<?php
			...
			$tags_list = get_the_term_list( $post->ID, 'twu-portfolio-tag', '', __( ', ', 'illustratr' ) );
			if ( $tags_list ) :
		?>
